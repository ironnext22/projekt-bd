...
INSERT INTO `filmy` VALUES (1,'Iron Man',1,1,1,1),(4,'aaa',1,1,NULL,NULL),(5,'Batman: Początek',2,1,2,2),(6,'Iron Man 2',1,1,1,1),(7,'Iron Man 3',1,1,1,1),(8,'Hobbit: Niezwykła Podróż',6,2,2,10),(9,'Harry Potter i Kamień Filozoficzny',8,2,2,11),(10,'Harry Potter i Komnata Tajemnic',8,2,2,11),(11,'Harry Potter i Więzień Azkabanu',8,2,2,11);
...
INSERT INTO `gatunek` VALUES (1,'Akcji'),(7,'Dramat'),(2,'Fantasy'),(8,'Horror'),(11,'Kryminał'),(10,'Romans'),(6,'Sci-fi'),(9,'Thriller');
...
INSERT INTO `klienci` VALUES (1,'Wiktor','Kowalski',2147483647,'ul. Warszawska','30-000','Kraków',300300300,'aaa@gmail.com'),(2,'Mateusz','Maź',2147483647,'ul. Poznańska 60','30-300','Kraków',666666666,'bbb@gmail.com'),(3,'Kacper','Filipek',111111111,'ul. Poznańska 20','30-300','Kraków',222222222,'ccc@gmail.com');
...
INSERT INTO `wypożyczenia` VALUES (1,1,1,'2023-05-20',7,50);
...
INSERT INTO `zwroty` VALUES (1,1,'2023-05-28');
...
-- Dump completed on 2023-05-21 13:47:35

create or replace procedure filmy()
begin
...
create or replace procedure kary()
begin
